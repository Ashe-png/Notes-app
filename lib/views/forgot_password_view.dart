        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            await showErrorDialog(context,
                "We could not process your requrest. Please make sure that you are a registered user.");
          }
        }
      },
      child: Scaffold(
          ...
          body: Padding(
            ...
            child: Column(
              children: [
                const Text(
                    'If you fogot your password, simply enter your email and we will send you a password reset link'),
                TextField(
